...
int main(int argc, char *argv[])
{
	...
	CheckError(3 != argc, "Debe haber 2 argumentos: archivo_salda  archivo_entrada", 1);
	...
	while (bytesLeidos > 0) {
		...
		CheckError(FALSE == Estado && BUF_SIZE != bytesEscritos, "No se ha escrito correctamente", 1);
	}
